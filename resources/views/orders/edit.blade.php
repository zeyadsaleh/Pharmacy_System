    ...
    <div class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 border rounded p-5">
        <div class="panel panel-info">
            ...
            <div class="panel-body pt-3">
                ...
                <form id="order" method="POST" action="{{route('orders.update',['order' => $order->id])}}"
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="addres" value="{{$order->delivering_address}}"
                            readonly>
                    </div>
                    ...
                    <p><b>Created by</b></p>
                    <div class="input-group">
                        <input type="text" class="form-control" name="creation_data" value="{{$order->created_by}}"
                            readonly>
                    </div>
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        <input type="text" class="form-control" name="dname"
                            value="{{$order->doctor? 'Dr. '.$order->doctor->name : " "}}" readonly>
                    </div>
                    ...
                    <p><b>Is Insured</b></p>
                    <div class="input-group">
                        <input type="text" class="form-control" name="isinsured"
                            value="{{$order->is_insured? 'Yes':'No'}}" readonly>
                    </div>
